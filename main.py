...
#Acess the playlist via: Log in to Spotify, Scroll to bottom and hit "Web Player- Useful links",
#Redirected to another pg, Playlist should be located on the bottom left